...
import { MDBRow, MDBCol, MDBInput, Input, Card, CardBody, CardTitle, MDBBtn } from 'mdbreact'
                    ...
                    <MDBRow>
                        <MDBCol md="6">
                            <Input
                                ...
                                onChange={onClickHidePhoneCheck} />
                        </MDBCol>
                        <MDBCol md="6">
                            <Input
                                ...
                                onChange={onClickMarketingCheck} />
                        </MDBCol>
                    </MDBRow>
                </CardBody>
            </Card>
